...
local entity = spawner.Create({
	Entity = {
		Name = "e",
		Asset = "https://github.com/Drop56796/Decoratebance/blob/main/Decoratebance.rbxm?raw=true",
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
...
---====== Display achievement ======---
achievementGiver({
    Title = "A Nightmare Time of Day",
    Desc = "I can see you I Found you",
    Reason = "Survive the Decoratebance",
